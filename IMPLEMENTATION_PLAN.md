...
- [x] Add Unit Tests (`tests/unit/test_montage.py`, `tests/unit/test_montage_edge_cases.py`)
- [x] Verify

## Phase 3: Reporting & Polish (PENDING)
## Goal
Enhance the reporting capabilities and polish the CLI.

## Tasks
- [ ] Refactor Reporting Service
- [ ] Add CLI Arguments for new features
- [ ] Final Verification
