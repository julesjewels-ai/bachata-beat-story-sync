...
- So the compilation that's run in full pipeline mode should actually have fades between the songs. I think there's an option at the moment for beat matching but they should definitely be some kind of fade or transition between the audio on the songs. 