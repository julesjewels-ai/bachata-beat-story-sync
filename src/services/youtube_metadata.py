...
_THUMBNAIL_CONCEPTS = [
    ...
    "Female dancer mid-spin, flowing dress — dark bg, gold accent text",
    "Vintage film-grain look: couple on dance floor — warm tones, title overlay",
    "Two people facing each other close — cinematic crop, coral colour grade",
]
...
def _build_description(
    ...
    parts += [
        "—",
        "🔔 Suscríbete para más bachata romántica y música para recordar.",
        "",
        "🔎 Palabras clave: música para recordar, canciones de amor, bachata, "
        "música para bailar, bachata para bailar, bachata vieja, música latina, "
