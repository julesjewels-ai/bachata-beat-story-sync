...
_THUMBNAIL_CONCEPTS = [
    ...
    "Female dancer mid-spin, flowing dress — contrast with dark bg, gold text",
    "Vintage film-grain look: couple on dance floor — faded warm tones",
...
def _build_description(
    ...
    parts += [
        "—",
        "🔔 Suscríbete para más bachata romántica, canciones de amor.",
        "",
