...
def build_pacing_kwargs(args: argparse.Namespace) -> dict:
    ...
    for attr, key in attr_map.items():
        ...
        # Check truthiness for strings and 'is not None' for numeric/opacity types.
        if attr in [
    ...
    bool_flags = {
        ...
        "pacing_crop_tighten": "pacing_crop_tighten",
        ...
        "pacing_warm_wash": "pacing_warm_wash",
        "pacing_alternating_bokeh": "pacing_alternating_bokeh",
    }
    for attr, key in bool_flags.items():
