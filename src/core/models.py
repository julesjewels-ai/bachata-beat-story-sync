...
class PhaseVariation(BaseModel):
    ...
    intro_effect: str = Field(
        "none",
        description="Visual effect for segments in this phase: 'none', 'bloom', 'vignette_breathe'",  # noqa: E501
    )
    intro_effect_duration: float | None = Field(
        None,
        description="Effect duration override in seconds. None = use global intro_effect_duration.",  # noqa: E501
    )
