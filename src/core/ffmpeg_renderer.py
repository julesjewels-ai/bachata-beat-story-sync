...
def _build_pacing_filters_for_segment(
    ...
    If seg.phase_pacing_effects is None, falls through to global config flags.
    If seg.phase_pacing_effects is a list (even empty), only named effects are active.
