...
class MontageGenerator:
    ...
    def _calculate_segment_params(
        ...
        if config.speed_ramp_organic:
            ...
            # achievable duration and later run out of frames when the curve is applied.
    ...
    def _fit_segment_adaptive(
        ...
        *,
        ...
        # Check if primary clip is a forced/numeric-prefixed clip (e.g. '01_intro.mp4')
    ...
    def build_segment_plan(
        ...
        for iteration in range(max_iterations):
            ...
            # Phase System: use highest-intensity clip when phase variation requests it,
