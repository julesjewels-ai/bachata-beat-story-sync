...
class MontageGenerator:
    ...
    def _calculate_segment_params(
        ...
        if config.speed_ramp_organic:
            ...
            # achievable duration and later run out of source frames
            # when the curve is applied.
    ...
    def _fit_segment_adaptive(
        ...
        *,
        ...
        # Check if primary clip is a forced/numeric-prefixed clip (e.g. '01_bumper.mp4')
    ...
    def build_segment_plan(
        ...
        for iteration in range(max_iterations):
            ...
            # If next clip is forced intro bumper, let it play to its actual duration
            ...
            # Video Phase System: use highest-intensity clip when phase variation
            # requests it, but only if no forced prefix clips are pending
            # and it's not a b-roll slot.
            _use_phase_hi = (
            ...
            if _use_phase_hi:
                ...
                # Don't advance forced_clip_idx - phase selection doesn't consume it
