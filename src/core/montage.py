...
class MontageGenerator:
    ...
    def _calculate_segment_params(
        ...
        if config.speed_ramp_organic:
            ...
            # achievable duration and later run out of source frames when the curve
            # is applied.
    ...
    def _fit_segment_adaptive(
        ...
        *,
        ...
        # Check if the primary clip is a forced/numeric-prefixed clip
        # (e.g. '01_intro-bumper.mp4')
    ...
    def build_segment_plan(
        ...
        for iteration in range(max_iterations):
            ...
            # If the next clip is a forced intro bumper/clip, let it play fully up to
            # its actual duration
            ...
            # requests it, but only if no forced prefix clips are pending and it's not
            # a b-roll slot.
            _use_phase_hi = (
            ...
            if _use_phase_hi:
                ...
                # Don't advance forced_clip_idx — phase selection doesn't consume
                # prefix clips
