...
class MontageGenerator:
    ...
    def _create_clip_sequence(
        ...
        """
        Generates a sequence of video clips to fill the total duration.
        """
    ...
    def generate(
        ...
        try:
            ...
            clips = self._create_clip_sequence(video_results, duration, bar_duration)
