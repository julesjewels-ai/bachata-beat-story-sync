...
from src.core.models import (
    AudioAnalysisResult, VideoAnalysisResult, VideoAnalysisInput, SUPPORTED_VIDEO_EXTENSIONS
)
...
class BachataSyncEngine:
    ...
    def __init__(
        ...
        cache_path: str = ".bachata_cache.json"
    ) -> None:
        if video_analyzer:
            ...
            cache_backend = JsonFileCache(cache_path)
