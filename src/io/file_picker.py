...
def _run_safe_tk_dialog(script: str, args: list[str] | None = None) -> str | None:
    ...
    Args:
        ...
        args: Optional list of string arguments to pass to the script via sys.argv
...
if path:
    print(path)
"""
    return _run_safe_tk_dialog(script, args=[title])
