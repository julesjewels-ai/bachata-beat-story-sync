...
**Delta:** Complexity Score 33 -> 10
**Summary:** Refactored a highly nested sequence of `if getattr(...)` conditions into simple mappings and iteration loops to reduce cyclomatic complexity and flatten the logic tree while maintaining exact semantic parity.
